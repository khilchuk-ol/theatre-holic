...
public class FindShows
{
    ...
    public void TitleFilter_Success()
    {
        ...
        var showsDomain = shows.Where(s => s.Title.Contains(title)).Select(s => Setup.Mapper.Map<TheatreHolic.Data.Models.Show, Show>(s)).ToList();
    ...
    public void MinDateFilter_Success()
    {
        ...
        var showsDomain = shows.Where(s => s.Date >= minDate).Select(s => Setup.Mapper.Map<TheatreHolic.Data.Models.Show, Show>(s)).ToList();
    ...
    public void MaxDateFilter_Success()
    {
        ...
        var showsDomain = shows.Where(s => s.Date <= maxDate).Select(s => Setup.Mapper.Map<TheatreHolic.Data.Models.Show, Show>(s)).ToList();
    ...
    public void AuthorIdsFilter_Success()
    {
        ...
        var showsDomain = shows.Where(s => authorIds.Contains(s.AuthorId)).Select(s => Setup.Mapper.Map<TheatreHolic.Data.Models.Show, Show>(s)).ToList();
    ...
    public void GenreIdsFilter_Success()
    {
        ...
        var showsDomain = shows.Where(s => genreIds.Contains(s.GenreId)).Select(s => Setup.Mapper.Map<TheatreHolic.Data.Models.Show, Show>(s)).ToList();
